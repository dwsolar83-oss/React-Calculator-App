...
describe('Calculator Reducer', () => {
  ...
  describe('Perform Operation', () => {
    ...
    it('should handle chained operations', () => {
      let state = calculatorReducer({ ...initialState, displayValue: '5' }, { type: EInputTypes.performOperation, payload: '+' });
      expect(state.value).toBe(5);
      expect(state.operator).toBe('+');

      state = calculatorReducer({ ...state, displayValue: '3' }, { type: EInputTypes.performOperation, payload: '=' });
    ...
    it('should set first operation', () => {
      const state = calculatorReducer({ ...initialState, displayValue: '5' }, { type: EInputTypes.performOperation, payload: '+' });
      expect(state.value).toBe(5);
      expect(state.operator).toBe('+');
